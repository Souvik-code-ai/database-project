...
const Login = () => {
  ...
  return (
    <div className='bg-linear-to-br min-[1000px]:w-[50%]  from-blue-50 via-white to-purple-50 flex flex-col justify-between items-center space-y-9 shadow-2xl min-[1000px]:mx-80 py-12 pt-35 rounded-3xl'>
      ...
      <Description style={'text-gray-500 min-[1080px]:text-3xl min-[380px]:text-3xl text-md text-center min-[344px]:mx-9 min-[375px]:mx-6 min-[768px]:mx-10'} description={'Securely access your account with your email and contact number.Fast,simple and protected login to get you started.'} />
      <input type="text" placeholder='Enter email' className='rounded-2xl w-[30%] h-12 p-5 min-[375px]:w-[80%] min-[344px]:w-[80%] hover:border-2 ' onChange={handleInputChange} name="email" value={nameValue} />
      <input type="text" placeholder='Enter Contact No.' className='rounded-2xl w-[30%] h-12 p-5 min-[375px]:w-[80%] min-[344px]:w-[80%] hover:border-2  ' onChange={handleInputChange} name="contact" value={contactValue} />
